...
ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'python-xray.qnmlgbsbd.kdns.fr')        # Argo固定隧道域名,留空即使用临时隧道
ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiZGVjOWYxNDMzMzIwZDIyOGY4MzU0ZGJlYzQ1MWI1MTAiLCJ0IjoiZDVhZmZkYTItYWE2MS00N2U5LTkwODQtYzYxMjQ5MDJhNTQwIiwicyI6Ik5qQTJaVFF6TW1VdE1UWTRNeTAwT1RCa0xUa3dZVGd0WVdFeU9UWXlPREJtTkdFeiJ9')            # Argo固定隧道密钥,留空即使用临时隧道
...
def get_files_for_architecture(architecture):
    if architecture == 'arm':
        base_files = [
            {"fileName": "web", "fileUrl": "https://github.com/yonggekkk/argosbx/releases/download/argosbx/sing-box-arm64"},
